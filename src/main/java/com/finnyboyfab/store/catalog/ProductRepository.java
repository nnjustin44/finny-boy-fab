...
public class ProductRepository {
    ...
    private final List<Product> products = List.of(
            ...
            new Product(
                    ...
                    "/images/optimized/products/maple-walnut-serving-board/maple-walnut-server.jpg",
            ...
            new Product(
                    ...
                    "/images/optimized/products/round-cherry-charcuterie-board/cherry-round-board.jpg",
    ...
    private static List<String> productImages(String folderName) {
        try {
            Resource[] resources = new PathMatchingResourcePatternResolver()
                    .getResources("classpath:/static/images/optimized/products/" + folderName + "/*");
            ...
            return Arrays.stream(resources)
                    ...
                    .map(filename -> "/images/optimized/products/" + folderName + "/" + filename)
                    .toList();
    ...
    private static int gallerySortOrder(String filename) {
        return switch (filename) {
            case "walnut-end-grain.jpg" -> 0;
            case "walnut-endgrain-2.jpg" -> 1;
            case "walnut-end-grain-3.jpg" -> 2;
            default -> 100;
        };
    }
}
